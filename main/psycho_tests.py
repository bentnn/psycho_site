...
test12 = [
    'Студентами (учениками), которым с трудом дается учеба, преподаватели (учителя) могут помыкать, как хотят',
    'Большая часть учебного времени в университете (школе) уходит на всякие бессмысленные занятия',
    'Умело воспользоваться шпаргалкой на контрольной или экзамене куда интереснее, чем учить все подряд',
    'Я не чувствую желания читать дополнительную литературу или ходить на факультативы',
    'Сколько ни учись, все, чего хотят преподаватели (учителя), все равно не выучишь',
    'Учиться бессмысленно: все равно основная масса полученных знаний в жизни не пригодится',
    'Время лекции или урока я часто использую для более интересных занятий',
    'Учеба кажется мне скучной и тягостной',
    'Оценка скорее зависит от желаний или настроения преподавателя (учителя), чем от знаний студента (ученика)',
    'Все время приходить на занятия подготовленным — слишком скучно',
    'Я не получаю удовольствия от учебы: просто вкладываю свое время и получаю оценки',
    'Люди, которые утверждают, что учиться всегда интересно, —просто лицемеры',
]

test13 = [
    'В основном моя жизнь близка к идеалу',
    'Обстоятельства моей жизни исключительно благоприятны',
    'Я полностью удовлетворен(а) моей жизнью',
    'У меня есть в жизни то, что мне по-настоящему нужно',
    'Если бы мне пришлось жить еще раз, я бы оставил(а) все как есть',
    'В целом я считаю себя очень счастливым(ой)',
    'По сравнению с большинством сверстников я более счастлив(а)',
    'Некоторые люди обычно очень счастливы. Они получают удовольствие от жизни,'
    ' что бы ни происходило, беря от жизни все. В большой степени это похоже на меня',
    'Некоторые люди обычно не особенно счастливы. Хотя они и не страдают депрессией,'
    ' похоже, они никогда не бывают так счастливы, как могли бы быть. В большой степени это похоже на меня',
]
...
about_tests = {
    ...
    'test7': {
        ...
        'info': 'Опросник по определению психологического состояния',
        'questions': test7,
        'image': 'test7.jpg',
        'model': Test7,
        'instruction':
    ...
    'test12': {
        'name': 'Шкала отчуждения от учебы и выгорания',
        'info': 'Подсчет уровня выгорания',
        'questions': test12,
        'image': 'test12.jpg',
        'model': Test12,
        'instruction':
            """Перед Вами список утверждений, которые описывают различные стороны нашей жизни.
            Пожалуйста, для каждого утверждения выберите цифру, соответствующую степени
            вашего согласия с этим утверждением.
            Помните, что здесь нет правильных и неправильных ответов.
            Нам интересно Ваше собственное мнение.
            Варианты ответов:
            1 - Совершенно не согласен(на)
            2 - Скорее не согласен(на)
            3 - Нечто среднее
            4 - Скорее согласен(на)
            5 - Совершенно согласен(на)""",
        'answers': [
            {'name': '1', 'value': '1'},
            {'name': '2', 'value': '2'},
            {'name': '3', 'value': '3'},
    ...
    'test13': {
        'name': 'Шкала субъективного счастья и удовлетворенности жизнью',
        'info': 'Подсчет уровня жизненного счастья',
        'questions': test13,
        'image': 'test13.jpg',
        'model': Test13,
        'instruction':
            """Ниже даны утверждения, с которыми Вы можете согласиться или не согласиться.
            Выразите степень Вашего согласия с каждым из них, выбрав оценку от 1 до 7.
