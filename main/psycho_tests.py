...
about_tests = {
    'test1': {
        ...
        'info': 'Тест на соотношение аудиального, визуального и кинестетического каналов восприятия.',
        'questions': test1,
        'image': 'test1.png',
        'model': Test1,
        'instruction':
    ...
    'test2': {
        ...
        'info': 'Тест для самооценки уровня реактивной и личностной тревожности в данный момент',
        'questions': test2,
        'image': 'test2.jpg',
        'model': Test2,
        'instruction':
            'Инструкция к тесту: Прочитайте внимательно каждое из приведенных ниже предложений и '
            'выберите соответствующую цифру в зависимости от того, как вы себя чувствуете в данный момент.\n'
    ...
    'test3': {
        ...
        'info': 'Опросник для дифференциальной диагностики депрессивных и близких к депрессии состояний',
        'questions': test3,
        'image': 'test3.webp',
        'model': Test3,
        'instruction':
            'Инструкция к тесту: Прочитайте внимательно каждое из приведенных ниже предложений и выберите '
            'соответствующую цифру в зависимости от того, как вы себя чувствуете в последнее время.\n'
            'Над вопросами долго не задумывайтесь, поскольку правильных или неправильных ответов нет\n'
    ...
    'test6': {
        ...
        'instruction':
            ...
            'Прочитайте каждое прилагательное и отметьте, в какой мере вы чувствовали себя так '
    ...
    'test9': {
        ...
        'instruction':
            ...
            'Необходимо выбрать одно из двух утверждений, которое, по вашему мнению, '
            'больше соответствует действительности, и оценить его, пользуясь указанной шкалой:\n'
    ...
    'test11': {
        ...
        'model': Test11,
        'instruction':
            'Ответьте, пожалуйста, на следующие вопросы, отмечая тот ответ, '
