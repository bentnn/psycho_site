...
def test1(request):
    ...
    if request.method == 'POST':
        ...
        message = count_test_1(data, request.user, via_telegram=False)
        ...
        # Test1.objects.create(user=request.user, audio=audio_res, visual=visual_res, kinest=kinest_res, message=message)
...
def test2(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_2(data, request.user, via_telegram=False)
        ...
        #
        # Test2.objects.create(user=request.user, rt=rt_res, lt=lt_res, message=message)
...
def test3(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_3(data, request.user, via_telegram=False)
        ...
        #
        # Test3.objects.create(user=request.user, ud=ud_res, message=message)
...
def test4(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_4(data, request.user, via_telegram=False)
        ...
        # Test4.objects.create(user=request.user, activity=activity_res, being=being_res, mood=mood_res, message=message)
    return render(request, 'test_page.html',
...
def test5(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_5(data, request.user, via_telegram=False)
        # sinc_q_yes = [6, 24, 36]
        ...
        # Test5.objects.create(user=request.user, sincerity=sinc_res, extrav=extrav_res, neuro=neuro_res, message=message)
    return render(request, 'test_page.html',
...
def test6(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_6(data, request.user, via_telegram=False)
        ...
        #                      negative_effect=negative_effect, message=message)
    return render(request, 'test_page.html',
...
def test7(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_7(data, request.user, via_telegram=False)
        ...
        #                      anxiety=anxiety, stress=stress, message=message)
    return render(request, 'test_page.html',
...
def test8(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_8(data, request.user, via_telegram=False)
        ...
        # Test8.objects.create(user=request.user, self_rating=self_rating, message=message)
    return render(request, 'test_page.html',
...
def test9(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_9(data, request.user, via_telegram=False)
        ...
        #                      general=general, message=message)
...
def test10(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_10(data, request.user, via_telegram=False)
        ...
        #                       social=social, psycho=psycho, general=general, message=message)
    return render(request, 'test_page.html',
...
def test11(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_11(data, request.user, via_telegram=False)
        # # count answers
...
def test12(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_12(data, request.user, via_telegram=False)
        ...
        #           f'{grade} уровень.\n{text}'
        # Test12.objects.create(user=request.user, burnout=burnout, message=message)
    return render(request, 'test_page.html',
...
def test13(request):
    ...
    if request.method == 'POST':
        data = forms.Form(request.POST).data
        message = count_test_13(data, request.user, via_telegram=False)
        ...
        # )
        # Test13.objects.create(user=request.user, satisfaction=satisfaction,
        #                       happiness=happiness, message=message)
    return render(request, 'test_page.html',
