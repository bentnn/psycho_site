...
urlpatterns = [
    ...
    path('telegramid/all_ids', views.TelAllTgIds.as_view(), name='get_stats_api'),
    path('telegramid/who_doesnt_pass/<test_name>/<int:days>', views.WhoDoesntPassTest.as_view(), name='get_stats_api'),
]
